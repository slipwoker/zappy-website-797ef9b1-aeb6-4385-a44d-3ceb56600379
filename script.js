    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "האקדמיה לניהול עסקים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '797ef9b1-aeb6-4385-a44d-3ceb56600379',
                    name: data.name || '',
                    email: data.email || '',
